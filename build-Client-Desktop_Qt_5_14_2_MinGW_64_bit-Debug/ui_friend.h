...
public:
    ...
    void setupUi(QWidget *Friend)
    {
        ...
        Friend->resize(572, 385);
        horizontalLayout = new QHBoxLayout(Friend);
        horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
        frien_LW = new QListWidget(Friend);
        frien_LW->setObjectName(QString::fromUtf8("frien_LW"));

        horizontalLayout->addWidget(frien_LW);
